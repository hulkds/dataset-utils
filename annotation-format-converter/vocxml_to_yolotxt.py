...
if __name__ == '__main__':
    ...
    # Get the annotations
    annotations = glob.glob('datasets/data_smoke/data_fp/annotations/val/' + '*.xml')
    annotations.sort()

    # Convert and save the annotations
    for ann in tqdm.tqdm(annotations):
        info_dict = extract_info_from_xml(ann)
        convert_to_yolo_txt('datasets/data_smoke/data_fp/annotations_yolotxt/val/', info_dict, class_name_to_id_mapping)
